...
export default function ArchiveCard({ post }: { post: Post }) {
    ...
    <div className="w-full px-1 lg:px-10 py-3">
      ...
      {post.mainImage ? (
        <Image
          ...
          src={urlForImage(post.mainImage).size(1000, 200).url()}
          height={1000}
          width={1000}
          alt=""
        />
      ...
      <div className="py-2">
        <p className="font-light text-lg lg:text-xl ">{post.excerpt}</p>
      </div>
